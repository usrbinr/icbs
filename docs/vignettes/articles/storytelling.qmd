...
#| fig-width: 10
#| fig-height: 0.4
caption_block("Source: Finance Department | Q4 2024", caption_size = 4)
```
...
title_block("**{#E63946 Category A} Leads**", title_size = 8) /
subtitle_block("Year-over-year comparison",subtitle_size = 6) /
chart /
caption_block("Source: Internal Analytics") +
    plot_layout(heights = c(0.10, 0.06, 0.78, 0.06))
```
...
Categories B and C lag behind.",
    size = 10
)

content <- chart + narrative + plot_layout(widths = c(0.65, 0.35))

title_block("**{#E63946 Category A} Leads**", title_size = 14) /
subtitle_block("Year-over-year comparison") /
content /
caption_block("Source: Internal Analytics") +
    plot_layout(heights = c(0.10, 0.06, 0.78, 0.06))
```
